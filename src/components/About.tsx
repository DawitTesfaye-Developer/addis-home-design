        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="block text-orange-800 text-2xl lg:text-3xl mt-2">
                Crafting Ethiopian Dreams Into Reality
              </span>
            </motion.h2>
            <motion.p 
              className="text-lg text-amber-800 mb-8 leading-relaxed"
              variants={itemVariants}
            >
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  <motion.div 
                    className="bg-gradient-to-r from-amber-200 to-orange-200 p-3 rounded-full border-2 border-red-200"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  >
                    <feature.icon className="h-6 w-6 text-amber-900" />
                  </motion.div>
                  <div>
          ...
          >
            <motion.div 
              className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border-4 border-gradient-to-r from-amber-300 via-orange-300 to-red-300"
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
              style={{
                backgroundImage: `linear-gradient(45deg, rgba(245, 158, 11, 0.1) 0%, rgba(249, 115, 22, 0.1) 50%, rgba(239, 68, 68, 0.1) 100%)`
              }}
            >
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div className="text-amber-800">አመት ልምድ</div>
                  <div className="text-xs text-amber-700">Years Experience</div>
                </motion.div>
                <motion.div 
                  className="text-center"
                  variants={statsVariants}
                ...
                >
                  ...
                  <div className="text-orange-800">ደስተኛ ደንበኞች</div>
                ...
                >
                  ...
                  <div className="text-red-800">የቤት እቃ ዲዛይኖች</div>
                  <div className="text-xs text-red-700">Furniture Designs</div>
                </motion.div>
                <motion.div 
                  className="text-center"
                  variants={statsVariants}
                ...
                >
                  ...
                  <div className="text-amber-800">የደንበኛ አገልግሎት</div>
                  <div className="text-xs text-amber-700">Customer Support</div>
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
